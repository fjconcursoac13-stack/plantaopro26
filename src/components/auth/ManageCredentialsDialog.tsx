...
export const ManageCredentialsDialog = forwardRef<HTMLDivElement, ManageCredentialsDialogProps>(
  function ManageCredentialsDialog({ open, onOpenChange }, ref) {
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent ref={ref} className="bg-card border-border max-w-md">
          <DialogHeader>
